...
class _RegisterFormState extends State<RegisterForm> {
  ...
  void _register() async {
    ...
    setState(() {
      ...
      _passwordErrorText = passwordValid ? null : 'Password must be at least 6 characters.';
      _confirmPasswordErrorText = confirmPasswordValid ? null : 'Passwords do not match';
      _phoneErrorText = phoneValid ? null : 'Invalid phone number';
      //_registerError = '';
    });

    if (usernameValid && emailValid && passwordValid && confirmPasswordValid && phoneValid) {
      setState(() {
        _isLoading = true;
      });
      ...
      if (userCreated) {
        ...
        setState(() {
          _registerError = "Email already in use. Please use a different email.";
        });
      }
    }
  }
